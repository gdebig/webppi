...
class Piifairlamp extends BaseController
{
    public function docs($id = false)
    {
        ...
        $data['data_bread'] = '';
        $data['stringbread'] = '<li class="breadcrumb-item active"><a href="' . base_url() . "/piifair/docs/" . $id . '">Dokumen FAIR</a></li><li class="breadcrumb-item active">Lampiran</li>';
        $data['logged_in'] = $session->get('logged_in');
        return view('maintemp/piilamp', $data);
    }
}
