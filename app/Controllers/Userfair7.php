...
class Userfair7 extends BaseController
{
    public function docs($id = false)
    {
        ...
        $data['title_page'] = "VII. Pernyataan";
        $data['data_bread'] = '';
        $data['stringbread'] = '<li class="breadcrumb-item active"><a href="'.base_url()."/userfair".'">Dokumen FAIR</a></li><li class="breadcrumb-item active">Pernyataan</li>';
