...
class Piifair52 extends BaseController
{
    public function docs($id = false)
    {
        ...
        $data['data_bread'] = '';
        $data['stringbread'] = '<li class="breadcrumb-item active"><a href="' . base_url() . "/piifair/docs/" . $id . '">Dokumen FAIR</a></li><li class="breadcrumb-item active">Makalah</li>';
        $data['logged_in'] = $session->get('logged_in');
        return view('maintemp/piidok52', $data);
    }
}
