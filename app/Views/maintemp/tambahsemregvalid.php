        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/seminarreg/tambahsemregproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="sem_judul" name="sem_judul" class="form-control" type="text" placeholder="Judul Seminar..." value="<?= set_value('sem_judul'); ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <select name="sem_term" id="sem_term" class="form-control">
                            <option value="Ganjil" <?= set_value('sem_term') == 'Ganjil' ? 'selected' : ''; ?>>Ganjil</option>
                            <option value="Genap" <?= set_value('sem_term') == 'Genap' ? 'selected' : ''; ?>>Genap</option>
                        </select>
                    </div>
                    <br />
