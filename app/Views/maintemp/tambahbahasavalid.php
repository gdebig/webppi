...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/userfair6/tambahbahasaproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="Name" class="element">Nama Bahasa <span class="required"> *</span>&nbsp;
                    </label>
                    <div class="element">
                        <input class="form-control" id="Name" name="Name" type="text" placeholder="Nama Bahasa..." value="<?= set_value('Name'); ?>" />
                    </div>
                    <br />
                    ...
                    <label for="WriteType" class="element">Jenis Tulisan yang Mampu Disusun <span class="required">
                            *</span>&nbsp; </label>
                    <div class="element">
                        <input class="form-control" id="WriteType" name="WriteType" type="text" placeholder="Jenis Tulisan yang Mampu Disusun..." value="<?= set_value('WriteType'); ?>" />
                    </div>
                    <br />
                    <label for="LangMark" class="element">Nilai TOEFL atau yang Sejenisnya</label>
                    <div class="element">
                        <input class="form-control" id="LangMark" name="LangMark" type="text" placeholder="Nilai TOEFL atau yang Sejenisnya..." value="<?= set_value('LangMark'); ?>" />
                    </div>
                    <br />
                            ...
                            foreach ($data_komp as $komp) :
                                ...
                                if ($komp['komp_parent'] == 'y') {
                                    ...
                                    if ($i == 1) {
                                        ...
                                        if (!empty(set_value("komp6"))) {
                                            $kompselected = array_search($komp['komp_code'], set_value("komp6")) !== false ? 'selected' : '';
                                        } else {
                                            $kompselected = '';
                                        }
