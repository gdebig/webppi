...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url();?>/userfair13/ubahorgproses" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="element">
                            <input id="City" name="City" class="form-control" type="text"
                                placeholder="Kota Organisasi..." value="<?php echo $City;?>" />
                        </div>
                        <br />
                        ...
                        <div class="element">
                            <input id="Country" name="Country" class="form-control" type="text"
                                placeholder="Negara Organisasi..." value="<?php echo $Country;?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="element">
                            <select name="StartPeriodBulan" id="StartPeriodBulan" class="form-control">
                                ...
                                <option value="September"
                                    <?php echo $StartPeriodBulan == "September" ? "selected" : ""?>>September</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="element">
                            <textarea id="Desc" name="Desc" class="form-control"
                                placeholder="Uraian Aktifitas Dalam Organisasi..."><?php echo $Desc;?></textarea>
                        </div>
                    </div>
