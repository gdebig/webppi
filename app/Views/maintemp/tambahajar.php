                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <select id="Period" name="Period" class="form-control">
                            <option value="smp9">1 - 9 tahun</option>
                            <option value="smp14">10 - 14 tahun</option>
                            <option value="smp19">15 - 19 tahun</option>
                            <option value="lbih20">> dari 20 tahun</option>
                        </select>
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <select id="Position" name="Position" class="form-control">
                            <option value="Stf">Staf Pengajar</option>
                            <option value="Pim">Pimpinan</option>
                        </select>
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <select id="Skshour" name="Skshour" class="form-control">
                            <option value="sks1">1 SKS / 15 Jam</option>
                            <option value="sks2">2 - 3 SKS / 30 - 45 Jam</option>
                            <option value="sks4">4 SKS / 60 Jam</option>
                        </select>
                    </div>
                    <br />
