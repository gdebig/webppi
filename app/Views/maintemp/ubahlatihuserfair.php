...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/userfair15/ubahlatihproses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <input class="form-control" id="Name" name="Name" type="text" placeholder="Nama Pendidikan/Pelatihan..." value="<?= $Name; ?>" />
                    </div><br />
                    ...
                    <label for="City" class="element">Kota Lokasi Pelatihan <span class="required">
                            *</span>&nbsp;</label>
                    <div class="element">
                        <input class="form-control" id="City" name="City" type="text" placeholder="Kota Lokasi Pelatihan..." value="<?= $Kota; ?>" />
                    </div>
                    <br />
                    <label for="Country" class="element">Negara Lokasi Pelatihan <span class="required">
                            *</span>&nbsp;</label>
                    <div class="element">
                        <input class="form-control" id="Country" name="Country" type="text" placeholder="Negara Lokasi Pelatihan..." value="<?= $Country; ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <select id="Length" name="Length" class="form-control">
                            ...
                            <option value="lbh240" <?php echo $Length == "lbih240" ? "selected" : ""; ?>>
