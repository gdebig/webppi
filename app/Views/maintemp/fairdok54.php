    ...
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col">
                    <div class="row">
                        <a href="<?php echo base_url();?>/userfair54/tambahinov" class="btn btn-primary">Tambah
                            Inovasi</a>
                    </div>
                </div>
                ...
                <div class="alert alert-danger">Data temuan/inovasi/paten belum ada. <a
                        href="<?= base_url();?>/userfair54/tambahinov">Klik
                        di sini untuk menambah data temuan/inovasi/paten</a></div>
                <?php }else{ ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center"><a
                                ...
                                <a href="<?php echo base_url();?>/userfair54/hapusinov/<?=$inov['Num'];?>"
                                    onclick="return confirm('Apakah anda yakin akan menghapus data temuan/inovasi/paten?')"
