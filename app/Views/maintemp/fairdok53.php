    ...
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col">
                    <div class="row">
                        <a href="<?php echo base_url(); ?>/userfair53/tambahseminar" class="btn btn-primary">Tambah
                            Seminar</a>
                    </div>
                </div>
                ...
                ?>
                    ...
                    <div class="alert alert-danger">Data seminar belum ada. <a href="<?= base_url(); ?>/userfair53/tambahseminar">Klik
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center"><a href="<?php echo base_url(); ?>/userfair53/ubahsem/<?= $sem['Num']; ?>" class="btn btn-warning"> <i class="fas fa-file-signature"></i> Ubah</a>
                                        <a href="<?php echo base_url(); ?>/userfair53/hapussem/<?= $sem['Num']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data seminar?')" class="btn btn-danger"> <i class="fas fa-trash"></i>
                                            Hapus</a>
                                    </td>
                                </tr>
                            <?php
