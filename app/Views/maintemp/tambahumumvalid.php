        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/manpengumuman/tambahumumproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="umum_name" name="umum_name" class="form-control" type="text" placeholder="Nama Pengumuman..." value="<?= set_value('umum_name'); ?>" />
                    </div>
                    <br />
                    <label for="umum_desc" class="element">Deskripsi <span class="required"> *</span>&nbsp;
                    </label>
                    <textarea class="form-control" id="umum_desc" name="umum_desc" placeholder="Deskripsi..."><?= set_value('umum_desc'); ?></textarea>
                    <br />
                    ...
                    <div class="element">
                        <select id="umum_tujuan" name="umum_tujuan" class="form-control">
                            <option value='ynn' <?= set_value('umum_tujuan') == 'ynn' ? 'selected' : ''; ?>>Calon Peserta</option>
                            <option value='nyn' <?= set_value('umum_tujuan') == 'nyn' ? 'selected' : ''; ?>>Peserta</option>
                            <option value='nny' <?= set_value('umum_tujuan') == 'nny' ? 'selected' : ''; ?>>Penilai</option>
                            <option value='yyn' <?= set_value('umum_tujuan') == 'yyn' ? 'selected' : ''; ?>>Calon Peserta dan Peserta</option>
                            <option value='yyy' <?= set_value('umum_tujuan') == 'yyy' ? 'selected' : ''; ?>>Semuanya</option>
                        </select>
                    </div><br /><br />
                    <div class="form-group">
