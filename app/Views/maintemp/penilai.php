                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center"><a href="<?php echo base_url(); ?>/manpenilai/ubahdatapenilai/<?= $user['user_id']; ?>" class="btn btn-warning"> <i class="fas fa-file-signature"></i> Ubah</a>
                                    </td>
                                </tr>
                            <?php
                            endforeach
