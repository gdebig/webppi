        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/userfair54/tambahinovproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="element">
                        <input class="form-control" id="Name" name="Name" type="text" placeholder="Judul / Nama Karya Temuan/Inovasi/Paten dan Implementasi Teknologi Baru..." value="<?= set_value('Name'); ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input class="form-control" id="Publication" name="Publication" type="text" placeholder="Media Publikasi Karya..." value="<?= set_value('Publication'); ?>" />
                    </div>
                    <br />
                            ...
                            foreach ($data_komp as $komp) :
                                ...
                                if ($komp['komp_parent'] == 'y') {
                                    ...
                                    if ($i == 1) {
                                        ...
                                        if (!empty(set_value("komp54"))) {
                                            $kompselected = array_search($komp['komp_code'], set_value("komp54")) !== false ? 'selected' : '';
                                        } else {
                                            $kompselected = '';
                                        }
