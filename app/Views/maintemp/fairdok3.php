    ...
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col">
                    <div class="row">
                        <a href="<?php echo base_url(); ?>/userfair3/tambahkerja" class="btn btn-primary">Tambah
                            Kualifikasi Profesional</a>
                    </div>
                </div>
                ...
                ?>
                    ...
                    <div class="alert alert-danger">Data kualifikasi profesional belum ada. <a href="<?= base_url(); ?>/userfair3/tambahkerja">Klik
                            di sini untuk menambah data kualifikasi profesional</a></div>
                <?php } else { ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center"><a href="<?php echo base_url(); ?>/userfair3/ubahkerja/<?= $kerja['Num']; ?>" class="btn btn-warning"> <i class="fas fa-file-signature"></i> Ubah</a>
                                        <a href="<?php echo base_url(); ?>/userfair3/hapuskerja/<?= $kerja['Num']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data kualifikasi profesional?')" class="btn btn-danger"> <i class="fas fa-trash"></i>
                                            Hapus</a>
                                    </td>
                                </tr>
                            <?php
