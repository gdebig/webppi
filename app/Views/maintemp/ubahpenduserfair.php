...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/userfair12/ubahpendproses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="Name" name="Name" class="form-control" type="text" placeholder="Nama Perguruan Tinggi..." value="<?php echo $Name; ?>" />
                    </div>
                    <br />
                    <label for=" Faculty" class="element">Fakultas <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input id="Faculty" name="Faculty" class="form-control" type="text" placeholder="Fakultas..." value="<?php echo $Faculty; ?>" />
                    </div>
                    <br />
                    <label for=" Major" class="element">Jurusan <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input id="Major" name="Major" class="form-control" placeholder="Jurusan..." type="text" value="<?php echo $Major; ?>" />
                    </div>
                    <br />
                    <label for=" City" class="element">Kota Perguruan Tinggi <span class="required"> *</span>&nbsp;
                    </label>
                    <div class="element">
                        <input id="City" name="City" class="form-control" placeholder="Kota Lokasi Perguruan Tinggi..." type="text" value="<?php echo $City; ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="Country" name="Country" class="form-control" placeholder="Negara Lokasi Perguruan Tinggi..." type="text" value="<?php echo $Country; ?>" />
                    </div>
                    <br />
                    <label for=" GradYear" class="element">Tahun Kelulusan <span class="required"> *</span>&nbsp;
                    </label>
                    <div class="element">
                        <input id="GradYear" name="GradYear" class="form-control" placeholder="Tahun Kelulusan..." type="text" value="<?php echo $GradYear; ?>" />
                    </div>
                    <br />
                    <label for=" Degree" class="element">Gelar <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input id="Degree" name="Degree" class="form-control" placeholder="Gelar..." type="text" value="<?php echo $Degree; ?>" />
                    </div>
                    <br />
                    <label for="Title" class="element">Judul Tugas Akhir/Skripsi/Tesis/Disertasi <span class="required">
                            *</span>&nbsp; </label>
                    <div class="element">
                        <textarea id="Title" name="Title" class="form-control" placeholder="Judul Tugas Akhir..."><?php echo $Title; ?></textarea>
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <textarea id="Desc" name="Desc" class="form-control" placeholder="Uraian Singkat Tugas Akhir..."><?php echo $Desc; ?></textarea>
                    </div>
                    <br />
                    <label for="Mark" class="element">Nilai Akademik Rata-rata <span class="required"> *</span>&nbsp;
                    </label>
                    <div class="element">
                        <input id="Mark" name="Mark" class="form-control" placeholder="Nilai Akademik Rata-rata..." type="text" value="<?php echo $Mark; ?>" />
                    </div>
                    <br />
                    <label for=" Judicium" class="element">Yudisium <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input id="Judicium" name="Judicium" class="form-control" placeholder="Yudisium..." type="text" value="<?php echo $Judicium; ?>" />
                    </div>
                    <br />
                    <div class=" form-group">
