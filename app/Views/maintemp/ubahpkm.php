...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/dosenpkm/ubahpkmproses" method="post" enctype="multipart/form-data">
                <input type="hidden" name="pkm_id" id="pkm_id" value="<?= $pkm_id; ?>" />
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="judul" name="judul" class="form-control" type="text" placeholder="Judul PKM..." value="<?= $judul; ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <select id="sumberdana" name="sumberdana" class="form-control">
                            <option value='Dalam Negeri' <?= $sumberdana == 'Dalam Negeri' ? 'selected' : ''; ?>>Dalam Negeri</option>
                            <option value='Luar Negeri' <?= $sumberdana == 'Luar Negeri' ? 'selected' : ''; ?>>Luar Negeri</option>
                            <option value='PT/Mandiri' <?= $sumberdana == 'PT/Mandiri' ? 'selected' : ''; ?>>PT/Mandiri</option>
                        </select>
                    </div>
                    <br />
                    ...
                    <div class="row">
                        <div class="col">
                            <button type="submit" name="submit" value="submit" class="btn btn-primary col">Ubah PKM</button>
                        </div>
                        <div class="col">
