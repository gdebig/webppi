...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url();?>/tugasakhir/bukurevisiproses" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="ta_bukurevisi" name="ta_bukurevisi" type="file" class="form-control"
                            placeholder="File Buku Revisi Praktek Keinsinyuran..." />
                    </div>
                    <br />
                    <div class="row">
                        <div class="col">
