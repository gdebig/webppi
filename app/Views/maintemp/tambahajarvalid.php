        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/userfair4/tambahajarproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="element">
                        <input class="form-control" id="Institution" name="Institution" type="text" placeholder="Nama Perguruan Tinggi/Lembaga..." value="<?= set_value('Institution'); ?>" />
                    </div><br />
                    <label for="Name" class="element">Nama Mata Ajaran <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input class="form-control" id="Name" name="Name" type="text" placeholder="Nama Mata Ajaran..." value="<?= set_value('Name'); ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input class="form-control" id="LocProv" name="LocProv" type="text" placeholder="Provinsi..." value="<?= set_value('LocProv'); ?>" />
                    </div>
                    <br />
                            ...
                            foreach ($data_komp as $komp) :
                                ...
                                if ($komp['komp_parent'] == 'y') {
                                    ...
                                    if ($i == 1) {
                                        ...
                                        if (!empty(set_value("komp4"))) {
                                            $kompselected = array_search($komp['komp_code'], set_value("komp4")) !== false ? 'selected' : '';
                                        } else {
                                            $kompselected = '';
                                        }
