...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        <div class="">
            <a href="<?= base_url(); ?>/mantareg">Kembali ke daftar Praktik Keinsinyuran PPI Reguler.</a>
        </div>
        <!-- /.card-header -->
        <div class="card">
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url(); ?>/mantareg/lihatformevaluasi/<?= $mhs_id; ?>/<?= $dosen_id; ?>/<?= $tar_id; ?>" target='_blank'>Lihat Form</a>
                                    </td>
                                </tr>
                            <?php
                            endforeach
