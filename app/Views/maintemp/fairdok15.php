        ...
        <div class="card">
            <div class="card-body">
                ...
                ?>
                    ...
                    <div class="alert alert-danger">Data pendidikan/pelatihan teknik/manajemen belum ada. <a href="<?= base_url(); ?>/userfair15/tambahlatih">Klik
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center"><a href="<?php echo base_url(); ?>/userfair15/ubahlatih/<?= $latih['Num']; ?>" class="btn btn-warning"> <i class="fas fa-file-signature"></i> Ubah</a>
                                        <a href="<?php echo base_url(); ?>/userfair15/hapuslatih/<?= $latih['Num']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data Pelatihan/Pendidikan?')" class="btn btn-danger"> <i class="fas fa-trash"></i>
                                            Hapus</a>
                                    </td>
                                </tr>
                            <?php
