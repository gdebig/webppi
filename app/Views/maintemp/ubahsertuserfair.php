...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        <div class="">
            <h3>Ubah Data Sertifikat Kompetensi dan Bidang Lainnya (Yang Relevan) Yang Diikuti</h3>
        </div>
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/userfair16/ubahsertproses" method="post" enctype="multipart/form-data">
                <input type="hidden" id="Num" name="Num" value=<?= $Num; ?>>
                <input type="hidden" id="filename" name="filename" value=<?= $File; ?>>
                <div class="form-group">
                    <label for="Name" class="element">Nama Sertifikat Kompetensi
                        <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input class="form-control" id="Name" name="Name" type="text" placeholder="Nama Sertifikat Kompetensi..." value="<?= $Name; ?>" />
                    </div><br />
                    ...
                    <label for="City" class="element">Kota Lokasi Sertifikat <span class="required">
                            *</span>&nbsp;</label>
                    <div class="element">
                        <input class="form-control" id="City" name="City" type="text" placeholder="Kota Lokasi Sertifikat..." value="<?= $Kota; ?>" />
                    </div>
                    <br />
                    <label for="Country" class="element">Negara Lokasi Sertifikat <span class="required">
                            *</span>&nbsp;</label>
                    <div class="element">
                        <input class="form-control" id="Country" name="Country" type="text" placeholder="Negara Lokasi Sertifikat..." value="<?= $Country; ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <select id="Length" name="Length" class="form-control">
                            ...
                            <option value="lbh240" <?php echo $Length == "lbh240" ? "selected" : ""; ?>>
                    ...
                    <div class="element">
                        <textarea class="form-control" id="Description" name="Description" placeholder="Deskripsi" placeholder="Uraian Singkat..."><?= $Description; ?></textarea>
                    </div>
                    <br />
                    ...
                    <br />
                    <label for="File" class="element">Bukti Sertifikat Kompetensi</label>
                    <div class="element">
