...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url();?>/userfair16/ubahsertproses" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <input class="form-control" id="Name" name="Name" type="text"
                            placeholder="Nama Sertifikat Kompetensi..." value="<?= $Name;?>" />
                    </div><br />
                    ...
                    <div class="element">
                        <input class="form-control" id="City" name="City" type="text"
                            placeholder="Kota Lokasi Sertifikat..." value="<?= $Kota;?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input class="form-control" id="Country" name="Country" type="text"
                            placeholder="Negara Lokasi Sertifikat..." value="<?= $Country;?>" />
                    </div>
                    <br />
