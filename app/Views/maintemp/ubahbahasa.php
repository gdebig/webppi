...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url();?>/userfair6/ubahbahasaproses" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <input class="form-control" id="WriteType" name="WriteType" type="text"
                            placeholder="Jenis Tulisan yang Mampu Disusun..." value="<?= $WriteType;?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input class="form-control" id="LangMark" name="LangMark" type="text"
                            placeholder="Nilai TOEFL atau yang Sejenisnya..." value="<?= $LangMark;?>" />
                    </div>
                    <br />
