...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        <div class="">
            <h3>Form Ubah Praktik Keinsinyuran</h3>
        </div>
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/regtugasakhir/ubahtarproses" method="post" enctype="multipart/form-data">
                <input type="hidden" name="tar_id" id="tar_id" value="<?= $tar_id; ?>">
                <input type="hidden" name="user_id" id="user_id" value="<?= $user_id; ?>">
                <input type="hidden" name="namabuku" id="namabuku" value="<?= $tar_buku; ?>">
                <input type="hidden" name="namalog" id="namalog" value="<?= $tar_log; ?>">
                <div class="form-group">
                    <label for="tar_usuljudul" class="element">Judul Praktik Keinsinyuran <span class="required">
                            *</span>&nbsp;
                    </label>
                    <div class="element">
                        <input id="tar_usuljudul" name="tar_usuljudul" class="form-control" type="text" placeholder="Judul Praktik Keinsinyuran..." value="<?= $tar_usuljudul; ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <select name="tar_semester" id="tar_semester" class="form-control">
                            <option value="Ganjil" <?= $tar_semester == 'Ganjil' ? "selected" : ""; ?>>Ganjil
                            </option>
                            <option value="Genap" <?= $tar_semester == 'Genap' ? "selected" : ""; ?>>Genap
                            </option>
                        </select>
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="tar_linkvideo" name="tar_linkvideo" type="text" class="form-control" placeholder="Link video..." value="<?= $tar_linkvideo; ?>" />
                    </div>
                    <br /><br />
                    <div class="form-group">
