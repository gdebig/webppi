    ...
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col">
                    <div class="row">
                        <a href="<?php echo base_url(); ?>/mantareg/tambahpenguji/<?= $tar_id; ?>/<?= $user_id; ?>" class="btn btn-primary">Atur Penguji</a>
                    </div>
                </div>
                ...
                ?>
                    ...
                    <div class="alert alert-danger">Data penguji proyek akhir belum ada. <a href="<?= base_url(); ?>/mantareg/tambahpenguji/<?= $tar_id; ?>/<?= $user_id; ?>">Klik
