        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/regtugasakhir/tambahtarproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="tar_usuljudul" name="tar_usuljudul" class="form-control" type="text" placeholder="Judul Praktik Keinsinyuran..." />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="instansi" name="instansi" class="form-control" type="text" placeholder="Nama Instansi..." />
                    </div>
                    <br />
                    ...
                    <br />
                    <label for="tar_log" class="element">Log Praktik Keinsinyuran (Form Log, Form Nilai Pembimbing, Lembar Pengesahan dan Lembar Persetujuan dijadikan 1 File)</label>
                    <div class="element">
                    ...
                    <div class="element">
                        <input id="tar_linkvideo" name="tar_linkvideo" type="text" class="form-control" placeholder="Link video..." />
                    </div>
                    <br /><br />
                    <div class="form-group">
