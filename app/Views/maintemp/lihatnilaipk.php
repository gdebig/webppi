...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        <div class="">
            <a href="<?= base_url();?>/manbimbing">Kembali ke daftar bimbingan.</a>
        </div>
        <!-- /.card-header -->
        <div class="card">
            <div class="card-body">
                ...
                <table id="tabledata" class="display table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url();?>/manbimbing/lihatformevaluasi/<?=$mhs_id;?>/<?=$dosen_id;?>/<?= $ta_id;?>"
                                    target='_blank'>Lihat Form</a>
                            </td>
                        </tr>
                        <?php 
                                    endforeach 
        ...
        <div class="card">
            <div class="card-body">
                <a href="<?= base_url();?>/manbimbing/berinilai/<?=$mhs_id;?>/<?=$dosen_id;?>/<?=$ta_id;?>"
                    class="btn btn-block btn-primary">Beri Nilai</a>
            </div>
        </div>
        <?php
            }
