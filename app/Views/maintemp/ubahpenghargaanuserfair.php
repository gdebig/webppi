...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/userfair14/ubahpenghargaanproses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="Name" name="Name" class="form-control" type="text" placeholder="Nama Tanda Penghargaan..." value="<?= $Name; ?>" />
                    </div>
                    <br>
                    ...
                    <div class="element">
                        <input id="Institute" name="Institute" class="form-control" type="text" placeholder="Nama Lembaga yang Memberikan..." value="<?= $Institute; ?>" />
                    </div>
                    <br>
                    ...
                    <div class="form-group">
                        <label for="Desc" class="element">Uraian Singkat Tanda Penghargaan<span class="required">
                                *</span>&nbsp;</label>
                        <div class="element">
                            <textarea id="Desc" name="Desc" class="form-control" placeholder="Uraian Singkat Tanda Penghargaan..."><?= $Desc; ?></textarea>
                        </div>
                    </div>
                    <br />
