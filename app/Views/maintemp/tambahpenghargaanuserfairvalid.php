        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/userfair14/tambahpenghargaanproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="Name" name="Name" class="form-control" type="text" placeholder="Nama Tanda Penghargaan..." value="<?= set_value('Name'); ?>" />
                    </div>
                    <br>
                    ...
                    <div class="element">
                        <input id="Institute" name="Institute" class="form-control" type="text" placeholder="Nama Lembaga yang Memberikan..." value="<?= set_value('Institute'); ?>" />
                    </div>
                    <br>
                    ...
                    <div class="form-group">
                        <label for="Desc" class="element">Uraian Singkat Tanda Penghargaan<span class="required">
                                *</span>&nbsp;</label>
                        <div class="element">
                            <textarea id="Desc" name="Desc" class="form-control" placeholder="Uraian Singkat Tanda Penghargaan..."><?= set_value('Desc'); ?></textarea>
                        </div>
                    </div>
                    <br />
                            ...
                            foreach ($data_komp as $komp) :
                                ...
                                if ($komp['komp_parent'] == 'y') {
                                    ...
                                    if ($i == 1) {
                                        ...
                                        if (!empty(set_value("komp14"))) {
                                            $kompselected = array_search($komp['komp_code'], set_value("komp14")) !== false ? 'selected' : '';
                                        } else {
                                            $kompselected = '';
                                        }
