...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url();?>/userfair13/tambahorgproses" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="element">
                            <input id="City" name="City" class="form-control" type="text"
                                placeholder="Kota Organisasi..." value="<?php echo set_value('City');?>" />
                        </div>
                        <br />
                        ...
                        <div class="element">
                            <input id="Country" name="Country" class="form-control" type="text"
                                placeholder="Negara Organisasi..." value="<?php echo set_value('Country');?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="element">
                            <select name="StartPeriodBulan" id="StartPeriodBulan" class="form-control">
                                <option value="Januari"
                                    <?php echo set_value('StartPeriodBulan') == "Januari" ? "selected" : ""?>>Januari
                                </option>
                                <option value="Februari"
                                    <?php echo set_value('StartPeriodBulan') == "Februari" ? "selected" : ""?>>Februari
                                </option>
                                <option value="Maret"
                                    <?php echo set_value('StartPeriodBulan') == "Maret" ? "selected" : ""?>>Maret
                                </option>
                                <option value="April"
                                    <?php echo set_value('StartPeriodBulan') == "April" ? "selected" : ""?>>April
                                </option>
                                <option value="Mei"
                                    <?php echo set_value('StartPeriodBulan') == "Mei" ? "selected" : ""?>>Mei</option>
                                <option value="Juni"
                                    <?php echo set_value('StartPeriodBulan') == "Juni" ? "selected" : ""?>>Juni</option>
                                <option value="Juli"
                                    <?php echo set_value('StartPeriodBulan') == "Juli" ? "selected" : ""?>>Juli</option>
                                <option value="Agustus"
                                    <?php echo set_value('StartPeriodBulan') == "Agustus" ? "selected" : ""?>>Agustus
                                </option>
                                <option value="September"
                                    <?php echo set_value('StartPeriodBulan') == "September" ? "selected" : ""?>>
                                    September</option>
                                <option value="Oktober"
                                    <?php echo set_value('StartPeriodBulan') == "Oktober" ? "selected" : ""?>>Oktober
                                </option>
                                <option value="November"
                                    <?php echo set_value('StartPeriodBulan') == "November" ? "selected" : ""?>>November
                                </option>
                                <option value="Desember"
                                    <?php echo set_value('StartPeriodBulan') == "Desember" ? "selected" : ""?>>Desember
                                </option>
                            </select>
                        </div>
                        <br />
                        ...
                        <div class="element">
                            <select name="EndPeriodBulan" id="EndPeriodBulan" class="form-control">
                                <option value="Januari"
                                    <?php echo set_value('EndPeriodBulan') == "Januari" ? "selected" : ""?>>Januari
                                </option>
                                <option value="Februari"
                                    <?php echo set_value('EndPeriodBulan') == "Februari" ? "selected" : ""?>>Februari
                                </option>
                                <option value="Maret"
                                    <?php echo set_value('EndPeriodBulan') == "Maret" ? "selected" : ""?>>Maret</option>
                                <option value="April"
                                    <?php echo set_value('EndPeriodBulan') == "April" ? "selected" : ""?>>April</option>
                                <option value="Mei" <?php echo set_value('EndPeriodBulan') == "Mei" ? "selected" : ""?>>
                                    Mei</option>
                                <option value="Juni"
                                    <?php echo set_value('EndPeriodBulan') == "Juni" ? "selected" : ""?>>Juni</option>
                                <option value="Juli"
                                    <?php echo set_value('EndPeriodBulan') == "Juli" ? "selected" : ""?>>Juli</option>
                                <option value="Agustus"
                                    <?php echo set_value('EndPeriodBulan') == "Agustus" ? "selected" : ""?>>Agustus
                                </option>
                                <option value="September"
                                    <?php echo set_value('EndPeriodBulan') == "September" ? "selected" : ""?>>September
                                </option>
                                <option value="Oktober"
                                    <?php echo set_value('EndPeriodBulan') == "Oktober" ? "selected" : ""?>>Oktober
                                </option>
                                <option value="November"
                                    <?php echo set_value('EndPeriodBulan') == "November" ? "selected" : ""?>>November
                                </option>
                                <option value="Desember"
                                    <?php echo set_value('EndPeriodBulan') == "Desember" ? "selected" : ""?>>Desember
                                </option>
                            </select>
                        </div>
                        <br />
