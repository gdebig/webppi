...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/tugasakhir/tambahtaproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="ta_usuljudul" class="element">Judul Praktek Keinsinyuran <span class="required">
                            *</span>&nbsp;
                    </label>
                    <div class="element">
                        <input id="ta_usuljudul" name="ta_usuljudul" class="form-control" type="text" placeholder="Judul Praktek Keinsinyuran..." value="<?= set_value('ta_usuljudul'); ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <select name="ta_semester" id="ta_semester" class="form-control">
                            <option value="Ganjil" <?= set_value('ta_semester') == 'Ganjil' ? "selected" : ""; ?>>Ganjil
                            </option>
                            <option value="Genap" <?= set_value('ta_semester') == 'Genap' ? "selected" : ""; ?>>Genap
                            </option>
                        </select>
                    </div>
                    <br />
