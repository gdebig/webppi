    ...
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title"><?= $FullName; ?>, Mata Kuliah Studi Kasus</h3>
            </div>
            <div class="card-body">

                <form action="<?php echo base_url(); ?>/mannilairpl/studikasussimpan" method="post" enctype="multipart/form-data">
                    <div class="sticky">
                        ...
                        <button type="submit" name="submit" value="submit" class="btn btn-primary col">Simpan Data Studi Kasus</button>
                    </div>
                    <!--UserFair3-->
