...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/mantareg/tambahbimbingproses" method="post" enctype="multipart/form-data">
                <input type="hidden" id="user_id" name="user_id" value="<?= $user_id; ?>">
                <input type="hidden" id="tar_id" name="tar_id" value="<?= $tar_id; ?>">
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title">Informasi Pembimbing</h3>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="penguji" class="element">Nama Pembimbing <span class="required">
                                    *</span>&nbsp;
                            </label>
                            <div class="element">
