        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/userfair16/tambahsertproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="element">
                        <input class="form-control" id="Name" name="Name" type="text" placeholder="Nama Sertifikat..." value="<?= set_value('Name'); ?>" />
                    </div><br />
                    ...
                    <label for="City" class="element">Kota Lokasi Sertifikat <span class="required">
                            *</span>&nbsp;</label>
                    <div class="element">
                        <input class="form-control" id="City" name="City" type="text" placeholder="Kota Lokasi Sertifikat..." value="<?= set_value('City'); ?>" />
                    </div>
                    <br />
                    <label for="Country" class="element">Negara Lokasi Sertifikat <span class="required">
                            *</span>&nbsp;</label>
                    <div class="element">
                        <input class="form-control" id="Country" name="Country" type="text" placeholder="Negara Lokasi Sertifikat..." value="<?= set_value('Country'); ?>" />
                    </div>
                    <br />
