                ...
                <div class="card card-primary card-tabs">
                    <div class="card-header p-0 pt-1">
                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-one-pendidikan-tab" data-toggle="pill" href="#custom-tabs-one-pendidikan" role="tab" aria-controls="custom-tabs-one-pendidikan" aria-selected="true">Pendidikan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-one-pengkerja-tab" data-toggle="pill" href="#custom-tabs-one-pengkerja" role="tab" aria-controls="custom-tabs-one-pengkerja" aria-selected="true">Pengalaman Kerja</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-one-organisasi-tab" data-toggle="pill" href="#custom-tabs-one-organisasi" role="tab" aria-controls="custom-tabs-one-organisasi" aria-selected="false">Organisasi</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-one-pelatihan-tab" data-toggle="pill" href="#custom-tabs-one-pelatihan" role="tab" aria-controls="custom-tabs-one-pelatihan" aria-selected="false">Pelatihan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-one-sertifikat-tab" data-toggle="pill" href="#custom-tabs-one-sertifikat" role="tab" aria-controls="custom-tabs-one-sertifikat" aria-selected="false">Sertifikat</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-one-kartul-tab" data-toggle="pill" href="#custom-tabs-one-kartul" role="tab" aria-controls="custom-tabs-one-kartul" aria-selected="false">Karya Tulis</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-one-seminar-tab" data-toggle="pill" href="#custom-tabs-one-seminar" role="tab" aria-controls="custom-tabs-one-seminar" aria-selected="false">Seminar</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-one-tabContent">
                            <div class="tab-pane fade show active" id="custom-tabs-one-pendidikan" role="tabpanel" aria-labelledby="custom-tabs-one-pendidikan-tab">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-one-pengkerja" role="tabpanel" aria-labelledby="custom-tabs-one-pengkerja-tab">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-one-organisasi" role="tabpanel" aria-labelledby="custom-tabs-one-organisasi-tab">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-one-sertifikat" role="tabpanel" aria-labelledby="custom-tabs-one-sertifikat-tab">
                                <?php if (isset($data_latih) && ($data_latih == "kosong")) {
                                ?>
                            ...
                            <div class="tab-pane fade" id="custom-tabs-one-kartul" role="tabpanel" aria-labelledby="custom-tabs-one-kartul-tab">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-one-seminar" role="tabpanel" aria-labelledby="custom-tabs-one-seminar-tab">
