...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/seminarreg/ubahsemregproses" method="post" enctype="multipart/form-data">
                <input type="hidden" name="sem_id" id="sem_di" value="<?= $sem_id; ?>" />
                <input type="hidden" name="oldsem_bukti" id="oldsem_bukti" value="<?= $sem_bukti; ?>" />
                <div class="form-group">
                    <label for="sem_judul" class="element">Judul Seminar <span class="required">
                            *</span>&nbsp;
                    </label>
                    <div class="element">
                        <input id="sem_judul" name="sem_judul" class="form-control" type="text" placeholder="Judul Seminar..." value="<?= $sem_judul; ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <select name="sem_term" id="sem_term" class="form-control">
                            <option value="Ganjil" <?= $sem_term == 'Ganjil' ? 'selected' : ''; ?>>Ganjil</option>
                            <option value="Genap" <?= $sem_term == 'Genap' ? 'selected' : ''; ?>>Genap</option>
                        </select>
                    </div>
                    <br />
