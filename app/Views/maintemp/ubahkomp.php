        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/mankomp/ubahkompproses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="code" name="code" class="form-control" type="text" placeholder="Kode..." value="<?= $komp_code; ?>" />
                    </div>
                    <br />
                    <label for="desc" class="element">Deskripsi <span class="required"> *</span>&nbsp;
                    </label>
                    <textarea class="form-control" id="desc" name="desc" placeholder="Deskripsi..."><?= $komp_desc; ?></textarea>
                    <br />
                    <label for="cat" class="element">Kategori <span class="required"> *</span>&nbsp;
                    </label>
                    <div class="element">
                        <input id="cat" name="cat" class="form-control" type="text" placeholder="Kategori..." value="<?= $komp_cat; ?>" />
                    </div><br />
