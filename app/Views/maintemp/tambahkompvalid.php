...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/mankomp/tambahkompproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="code" class="element">Kode <span class="required"> *</span>&nbsp;
                    </label>
                    <div class="element">
                        <input id="code" name="code" class="form-control" type="text" placeholder="Kode..." value="<?= set_value('code'); ?>" />
                    </div>
                    <br />
                    <label for="desc" class="element">Deskripsi <span class="required"> *</span>&nbsp;
                    </label>
                    <textarea class="form-control" id="desc" name="desc" placeholder="Deskripsi..."><?= set_value('desc'); ?></textarea>
                    <br />
                    <label for="cat" class="element">Kategori <span class="required"> *</span>&nbsp;
                    </label>
                    <div class="element">
                        <input id="cat" name="cat" class="form-control" type="text" placeholder="Kategori..." value="<?= set_value('cat'); ?>" />
                    </div><br />
