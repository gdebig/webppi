        ...
        <div class="card">
            <div class="card-body">
                ...
                ?>
                    ...
                    <div class="alert alert-danger">Data penilai belum ada. <a href="<?= base_url(); ?>/manpenilai/tambahpenilai">Klik
                            di sini untuk menambah data penilai</a></div>
                <?php } else { ?>

                    <form action="<?php echo base_url(); ?>/mancapes/prosescapes" method="post" enctype="multipart/form-data">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url(); ?>/mancapes/doklengkap/<?= $user['user_id']; ?>"><?= empty($user['FullName']) ? $user['username'] . " (Belum isi Profile)" : $user['FullName']; ?></a>
                                        </td>
                                        <td><?php
                                        ...
                                        <td>
                                            ...
                                            if ($isprofile == "Ada") {
                                            ?>
                                                <a href="<?= base_url(); ?>/mancapes/profile/<?= $user['user_id']; ?>"><?= $isprofile; ?></a>
                                            <?php
                                            } else {
                                                echo $isprofile;
                                            }
                                        ...
                                        <td>
                                            ...
                                            if ($ispend == "Ada") {
                                            ?>
                                                <a href="<?= base_url(); ?>/mancapes/pendidikan/<?= $user['user_id']; ?>"><?= $ispend; ?></a>
                                            <?php
                                            } else {
                                                echo $ispend;
                                            }
                                        ...
                                        <td>
                                            ...
                                            if ($ispengkerja == "Ada") {
                                            ?>
                                                <a href="<?= base_url(); ?>/mancapes/kerja/<?= $user['user_id']; ?>"><?= $ispengkerja; ?></a>
                                            <?php
                                            } else {
                                                echo $ispengkerja;
                                            }
