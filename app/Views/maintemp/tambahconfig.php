        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/manconfig/tambahconfigproses" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="config_name" name="config_name" class="form-control" type="text" placeholder="Nama Konfigurasi..." />
                    </div>
                    <br />
                    <label for="config_value" class="element">Value <span class="required"> *</span>&nbsp;
                    </label>
                    <textarea class="form-control" id="config_value" name="config_value" placeholder="Value..."></textarea>
                    <br /><br />
                    <div class="form-group">
