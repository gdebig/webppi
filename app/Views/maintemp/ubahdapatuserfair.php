...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/userfair22/ubahdapatproses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <textarea id="Desc" name="Desc" class="form-control" placeholder="Pengertian, Pendapat dan Pengalaman Sendiri..."><?= $Desc; ?></textarea>
                    </div>
                    <br />
                    <div class="form-group">
