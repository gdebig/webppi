    ...
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col">
                    <div class="row">
                        <a href="<?php echo base_url(); ?>/register/tambahorganisasi" class="btn btn-primary">Tambah
                            Data Organisasi</a>
                    </div>
                </div>
                ...
                ?>
                    ...
                    <div class="alert alert-danger">Data organisasi belum ada. <a href="<?= base_url(); ?>/register/tambahorganisasi">Klik
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center"><a href="<?php echo base_url(); ?>/register/ubahorg/<?= $org['Num']; ?>" class="btn btn-warning"> <i class="fas fa-file-signature"></i> Ubah</a>
                                        <a href="<?php echo base_url(); ?>/register/hapusorg/<?= $org['Num']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data organisasi?')" class="btn btn-danger"> <i class="fas fa-trash"></i>
                                            Hapus</a>
                                    </td>
                                </tr>
                            <?php
