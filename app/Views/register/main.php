            ...
            <div class="col">
                <div class="color-palette-set">
                    ...
                    <div class="bg-primary disabled color-palette text-left"><span class="m-3">
                            <ul>
                                <li>Apakah ini adalah kunjungan pertama anda? Jika iya, klik <a href="<?php echo base_url(); ?>/register/buatakun" class="alert-warning">link
                                        ini.</a><br />
                                    ...
                                    didapat dari <a href="https://penerimaan.ui.ac.id" target="_blank" class="alert-warning">penerimaan.ui.ac.id</a>.
                                </li>
                                <li>Apakah ini adalah kunjungan yang kedua dan seterusnya? Jika iya, klik <a href="<?php echo base_url(); ?>/register/capes" class="alert-warning">link
                                        ini.</a><br />
