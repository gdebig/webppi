                ...
                <div class="form-group">
                    <div class="form-group mb-0">
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="terms2" class="custom-control-input" id="terms2" value="Ya" <?php echo $confirmcapes == "Ya" ? "checked" : ""; ?>>
                    ...
                    <div>
                        <div class="row">
                            <div class="col">
                                <button type="submit" name="submit" value="submit" class="btn btn-primary col" onclick="return confirm('Setelah klik tombol konfirmasi, anda tidak dapat mengubah dokumen pendaftaran. Anda sudah Yakin?')">Simpan
                                    dan
