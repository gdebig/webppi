                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td style="text-align: center"><a href="<?php echo base_url(); ?>/register/ubahlatih/<?= $latih['Num']; ?>" class="btn btn-warning"> <i class="fas fa-file-signature"></i> Ubah</a>
                                        <a href="<?php echo base_url(); ?>/register/hapuslatih/<?= $latih['Num']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data Pelatihan/Pendidikan?')" class="btn btn-danger"> <i class="fas fa-trash"></i>
                                            Hapus</a>
                                    </td>
                                </tr>
                            <?php
