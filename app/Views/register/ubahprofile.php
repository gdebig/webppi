...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url();?>/register/ubahprofileproses" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="fullname" name="fullname" type="text" class="form-control"
                                    placeholder="Nama Lengkap..." value="<?php echo $FullName;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="birthplace" name="birthplace" type="text" class="form-control"
                                    placeholder="Tempat Lahir..." value="<?php echo $BirthPlace;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control float-right data-datepicker" id="birthdate"
                                    name="birthdate" placeholder="Tanggal Lahir..." value="<?php echo $BirthDate;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="kta" name="kta" type="text" class="form-control"
                                    placeholder="Nomor Kartu Tanda Anggota (KTA)..." value="<?php echo $KTA;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="element">
                                <textarea id="haddress" name="haddress" class="form-control"
                                    placeholder="Alamat Rumah..."><?php echo $HAddr;?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="hpostnum" name="hpostnum" type="text" class="form-control"
                                    placeholder="Kode Pos..." value="<?php echo $HPostnum;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="hnum" name="hnum" type="text" class="form-control"
                                    placeholder="Telepon Rumah..." value="<?php echo $Hnum;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="hpnum" name="hpnum" type="text" class="form-control"
                                    placeholder="Nomor Mobile..." value="<?php echo $Hpnum;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="hfaks" name="hfaks" type="text" class="form-control"
                                    placeholder="Nomor Faks Rumah..." value="<?php echo $Hfaks;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="htelex" name="htelex" type="text" class="form-control"
                                    placeholder="Nomor Telex Rumah..." value="<?php echo $Htelex;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="work" name="work" type="text" class="form-control"
                                    placeholder="Tempat Kerja..." value="<?php echo $Work;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="position" name="position" type="text" class="form-control"
                                    placeholder="Posisi/Jabatan..." value="<?php echo $Position;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <textarea id="waddr" name="waddr" class="form-control"
                                    placeholder="Alamat Kantor..."><?php echo $WAddr;?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="wcity" name="wcity" type="text" class="form-control"
                                    placeholder="Kota Alamat Kantor..." value="<?php echo $WCity;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="wpostnum" name="wpostnum" type="text" class="form-control"
                                    placeholder="Kode Pos Alamat Kantor..." value="<?php echo $Wpostnum;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="wnum" name="wnum" type="text" class="form-control"
                                    placeholder="Telepon Kantor..." value="<?php echo $Wnum;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="wfaks" name="wfaks" type="text" class="form-control"
                                    placeholder="Nomor Faks Kantor..." value="<?php echo $Wfaks;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="wtelex" name="wtelex" type="text" class="form-control"
                                    placeholder="Nomor Telex Kantor..." value="<?php echo $Wtelex;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="wemail1" name="wemail1" type="text" class="form-control"
                                    placeholder="Email Kantor 1..." value="<?php echo $Wemail1;?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="element">
                                <input id="wemail2" name="wemail2" type="text" class="form-control"
                                    placeholder="Email Kantor 2..." value="<?php echo $Wemail2;?>" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="element">
                                <select name="pindahregular" id="pindahregular" class="form-control">
                                    <option value="Ya" <?php echo $pindahregular == "Ya" ? "selected" : "";?>>Ya
                                    </option>
                                    <option value="Tidak" <?php echo $pindahregular == "Tidak" ? "selected" : "";?>>
                                        Tidak
                                    </option>
                                </select>
                            </div>
