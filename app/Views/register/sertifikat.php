                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td style="text-align: center"><a href="<?php echo base_url(); ?>/register/ubahsert/<?= $latih['Num']; ?>" class="btn btn-warning"> <i class="fas fa-file-signature"></i> Ubah</a>
                                        <a href="<?php echo base_url(); ?>/register/hapussert/<?= $latih['Num']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data Sertifikat?')" class="btn btn-danger"> <i class="fas fa-trash"></i>
                                            Hapus</a>
                                    </td>
                                </tr>
                            <?php
