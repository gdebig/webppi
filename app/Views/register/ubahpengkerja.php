...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url(); ?>/register/ubahpengkerjaproses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control float-right data-datepicker" id="startdate" name="startdate" placeholder="Tanggal Mulai Kerja..." value="<?php echo $StartDate; ?>" />
                    </div><br />
                    <div class="element">
                        <input type="checkbox" id="masihkerja" name="masihkerja" value="masihkerja" <?php echo $masihkerja; ?>> <label for="masihkerja">Saya masih bekerja</label>
                    </div><br />
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control float-right data-datepicker" id="enddate" name="enddate" placeholder="Tanggal Berakhir Kerja..." value="<?php echo $EndDate; ?>" />
                    </div><br />
                    <label for="NameInstance" class="element">Nama Instansi / Perusahaan
                        <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input class="form-control" id="NameInstance" name="NameInstance" type="text" placeholder="Nama Instansi / Perusahaan..." value="<?php echo $NameInstance; ?>" />
                    </div><br />
                    <label for="Position" class="element">Jabatan/Tugas <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input class="form-control" id="Position" name="Position" type="text" placeholder="Jabatan/Tugas..." value="<?php echo $Position; ?>" />
                    </div>
                    <br />
                    <label for="Name" class="element">Nama Aktifitas/Kegiatan/Proyek</label>
                    <div class="element">
                        <input class="form-control" id="Name" name="Name" type="text" placeholder="Nama Aktifitas/Kegiatan/Proyek..." value="<?php echo $Name; ?>" />
                    </div>
                    <br />
                    <label for="Giver" class="element">Pemberi Tugas</label>
                    <div class="element">
                        <input class="form-control" id="Giver" name="Giver" type="text" placeholder="Pemberi Tugas..." value="<?php echo $Giver; ?>" />
                    </div>
                    <br />
                    <label for="LocCity" class="element">Kota <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input class="form-control" id="LocCity" name="LocCity" type="text" placeholder="Kota..." value="<?php echo $LocCity; ?>" />
                    </div>
                    <br />
                    <label for="LocProv" class="element">Provinsi <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input class="form-control" id="LocProv" name="LocProv" type="text" placeholder="Provinsi..." value="<?php echo $LocProv; ?>" />
                    </div>
                    <br />
                    <label for="LogCountry" class="element">Negara <span class="required"> *</span>&nbsp; </label>
                    <div class="element">
                        <input class="form-control" id="LocCountry" name="LocCountry" type="text" placeholder="Negara..." value="<?php echo $LocCountry; ?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input class="form-control" id="ProjValue" name="ProjValue" type="text" placeholder="Nilai Proyek..." value="<?php echo $ProjValue; ?>" />
                    </div>
                    <br />
                    <label for="RspnValue" class="element">Nilai Tanggung Jawab</label>
                    <div class="element">
                        <input class="form-control" id="RspnValue" name="RspnValue" type="text" placeholder="Nilai Tanggung Jawab..." value="<?php echo $RspnValue; ?>" />
                    </div>
                    <br />
                    ...
                    <label for="Desc" class="element">Uraian Singkat Tugas dan Tanggung Jawab Profesional sesuai
                        NSPK</label>
                    <div class="element">
                        <textarea class="form-control" id="Desc" name="Desc" placeholder="Deskripsi" placeholder="Uraian Singkat..."><?php echo $Desc; ?></textarea>
                    </div>
                    <br />
