...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        {
        ?>
        <div class="alert alert-danger">Data profile belum ada. <a href="<?= base_url();?>/register/buatprofile">Klik
        ...
        <div class="card card-warning">
            <div class="card-header">
                <h3 class="card-title">Informasi Lain</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table class="table table-striped">
                    <tr>
                        <td width="30%">Nomor SIP</td>
                        <td width="5%" style="text-align:center">:</td>
                        <td width="65%"><?php
                        if (!empty($SIP)){
        ...
        <div class="card">
            <div class="card-body">
                <a href="<?= base_url();?>/register/ubahprofile/<?= $user_id;?>" class="btn btn-block btn-primary">Ubah
                    Profile</a>
            </div>
        </div>
        <?php
