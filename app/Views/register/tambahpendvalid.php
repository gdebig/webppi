...
<div class="card card-primary" style="width: auto; margin: 30px;">
    <div class="col-sm-13" style="width: auto; margin: 30px;">
        ...
        <div class="card-body" style="width: auto; margin: 30px;">
            <form action="<?php echo base_url();?>/register/tambahpendproses" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="element">
                        <input id="Name" name="Name" class="form-control" type="text"
                            placeholder="Nama Perguruan Tinggi..." value="<?php echo set_value('Name');?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="Faculty" name="Faculty" class="form-control" type="text" placeholder="Fakultas..."
                            value="<?php echo set_value('Faculty');?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="City" name="City" class="form-control" placeholder="Kota Lokasi Perguruan Tinggi..."
                            type="text" value="<?php echo set_value('City');?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="Degree" name="Degree" class="form-control" placeholder="Gelar..." type="text"
                            value="<?php echo set_value('Degree');?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <textarea id="Title" name="Title" class="form-control"
                            placeholder="Judul Tugas Akhir..."><?php echo set_value('Title');?></textarea>
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <textarea id="Desc" name="Desc" class="form-control"
                            placeholder="Uraian Singkat Tugas Akhir..."><?php echo set_value('Desc');?></textarea>
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="Mark" name="Mark" class="form-control" placeholder="Nilai Akademik Rata-rata..."
                            type="text" value="<?php echo set_value('Mark');?>" />
                    </div>
                    <br />
                    ...
                    <div class="element">
                        <input id="Judicium" name="Judicium" class="form-control" placeholder="Yudisium..." type="text"
                            value="<?php echo set_value('Judicium');?>" />
                    </div>
                    <br />
                    <div class=" form-group">
