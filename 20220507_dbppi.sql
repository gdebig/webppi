...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 07, 2022 at 01:07 PM
...
(2, 4, '2022-05-01', '0000-00-00', 'Test Instansi', 'Big Boss', '', '', 'Depok', 'Jawa Barat', 'Indonesia', 'smp3', 'supervisor', '1 Milyar', '100', 'bny', 'sed', 'sed', 'Tinggi', '', '2022-05-06 16:31:47', '2022-05-05 17:00:00');
...
CREATE TABLE IF NOT EXISTS `tbl_organisasi` (
  ...
  PRIMARY KEY (`Num`) USING BTREE,
  KEY `ID` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='Bagian I.3';
...
(1, 4, 'Test Organisasi', 'PII', 'Depok', 'Indonesia', 'sd5', 'Juni', 2018, 'Januari', 2022, 'Peng', 'Reg', 'Mas', 'Membantu pengurus', '', '2022-05-05 17:00:00', '2022-05-05 17:00:00');
